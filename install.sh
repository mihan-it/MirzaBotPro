...
function show_animated_logo() {
    ...
    type_text_colored "\033[1;31m" "╚═╝░░░░░╚═╝ ╚═╝ ╚═╝░░╚═╝ ╚══════╝ ╚═╝░░╚═╝ ╚═╝░░░░░ ╚═╝░░╚═╝ ░╚════╝░" 0.003
    echo ""
    type_text_colored "\033[1;33m" "                    Mirza Pro Bot Installer v3.5" 0.015
    type_text_colored "\033[1;36m" "                    Developer: Mihan IT" 0.015
    type_text_colored "\033[1;36m" "                    debugger:  github.com/mihan-it/MirzaBotPro" 0.015
    echo ""
}
...
function install_bot() {
    ...
    ZIP_URL=$(curl -s https://api.github.com/repos/mihan-it/MirzaBotPro/releases/latest | grep "zipball_url" | cut -d '"' -f 4)

if [[ "$1" == "-v" && "$2" == "beta" ]] || [[ "$1" == "-beta" ]] || [[ "$1" == "-" && "$2" == "beta" ]]; then
    ZIP_URL="https://github.com/mihan-it/MirzaBotPro/archive/refs/heads/main.zip"
elif [[ "$1" == "-v" && -n "$2" ]]; then
    ZIP_URL="https://github.com/mihan-it/MirzaBotPro/mirza_pro/archive/refs/tags/$2.zip"
fi
...
function install_bot_with_marzban() {
    ...
    if [[ "$1" == "-v" && "$2" == "beta" ]] || [[ "$1" == "-beta" ]] || [[ "$1" == "-" && "$2" == "beta" ]]; then
        ...
        ZIP_URL="https://github.com/mihan-it/MirzaBotPro/archive/refs/tags/$2.zip"
    fi
...
function update_bot() {
    ...
    if [[ "$1" == "-beta" ]] || [[ "$1" == "-v" && "$2" == "beta" ]]; then
        ...
        ZIP_URL=$(curl -s https://api.github.com/repos/mihan-it/MirzaBotPro/releases/latest | grep "zipball_url" | cut -d '"' -f4)
    fi
...
EOF"
    ...
    git clone https://github.com/mihan-it/MirzaBotPro.git "$BOT_DIR" || {
...
function update_additional_bot() {
    ...
    if ! git clone https://github.com/mihan-it/MirzaBotPro.git "$BOT_PATH"; then
